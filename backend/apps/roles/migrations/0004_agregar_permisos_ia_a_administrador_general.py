"""Otorga los permisos nuevos `dashboard.interpretar`/`dashboard.hallazgos_ia` (agregados al
catálogo para separar el uso de IA de simplemente poder ver un dashboard — control de costo del
LLM) al rol ADMINISTRADOR_GENERAL — igual que en las migraciones 0002/0003, un permiso nuevo en
el catálogo no se asigna automáticamente a un grupo ya creado.
